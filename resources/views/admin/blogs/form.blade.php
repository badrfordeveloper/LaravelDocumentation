        ...
        <div class="row">
            <div class="col-md-8 col-12">
                <div class="mb-1">
                    ...
                    <input required value="{{ old('title', @$blog->title) }}" name="title" placeholder="{{ __('labels.title')}}"  type="text" class="form-control" />
                    @if ($errors->has('title'))
            ...
            <div class="col-md-4 col-12">
                <div class="mb-1">
                    ...
                    <div class="form-check form-switch">
                        <input type="checkbox" @if (old('active',@$blog->active)) checked @endif name="active" class="form-check-input" id="active" />
            ...
            <div class="col-md-12 col-12">
                <div class="mb-1">
                    ...
                    <textarea id="short_description" class="form-control editor" name="short_description">{{ old('short_description', @$blog->short_description) }}</textarea>
            ...
            <div class="col-md-12 col-12">
                <div class="mb-1">
                    ...
                    <textarea id="description" class="form-control editor" name="description">{{ old('description', @$blog->description) }}</textarea>
