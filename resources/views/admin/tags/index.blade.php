    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{__('List') }} {{ __('tags') }}</h2>
                            ...
                            <div class="card p-1">
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="dt-action-buttons text-end">
                                        @can('tags.create')
                                            <a href="{{route(BASE_ADMIN_PATH.'.tags.create')}}" class="dt-button create-new btn btn-primary ajax-modal "><span><i data-feather='plus'></i></span></a>
                                        @endcan
                                    </div>
                                </div>
