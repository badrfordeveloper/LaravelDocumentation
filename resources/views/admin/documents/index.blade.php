    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{__('List') }} {{ __('documents') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url(BASE_ADMIN_URL) }}">{{ __('Dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{__('List') }} {{ __('documents') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-header border-bottom p-1">
                                    ...
                                    <div class="dt-action-buttons text-end">
                                        @can('documents.create')
                                            <a href="{{route(BASE_ADMIN_PATH.'.documents.create')}}" class="dt-button create-new btn btn-primary"><span><i data-feather='plus'></i></span></a>
                                        @endcan
                                    </div>
                                </div>
