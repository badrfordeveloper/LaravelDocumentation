                        ...
                        <div class="info-container">
                            <div class="list-unstyled row">
                                <div class="mb-75 col-6">
                                    ...
                                    <span>{{ $shippingMethod->render('title') }}</span>
                                </div>
                                <div class="mb-75 col-6">
                                    <span class="fw-bolder me-25">{{ __('labels.cost') }}</span>
                                    <span>{{ $shippingMethod->render('cost') }}</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center pt-2">
                                @can('%plural%.edit')
                                <a href="{{route(BASE_ADMIN_PATH.'.shipping_methods.edit',$shippingMethod->id)}}" class="btn btn-primary me-1 ajax-modal">
                                    {{ __('Edit') }}
                                </a>
                                @endcan
                            </div>
