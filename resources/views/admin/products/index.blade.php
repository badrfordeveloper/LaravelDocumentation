                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper d-inline-block">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('Products List') }}</li>
                        </ol>
                    </div>
                    <div class="dt-action-buttons text-end float-end" >
                        @can('products.create')
                            <a href="{{route(BASE_ADMIN_PATH.'.products.create')}}" class="dt-button create-new btn btn-primary"><span><i data-feather='plus'></i></span></a>
                        @endcan
                    </div>
                </div>
