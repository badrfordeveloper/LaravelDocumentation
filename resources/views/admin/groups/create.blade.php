    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('New') }} {{__('of')}} {{ __('group') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url(BASE_ADMIN_URL) }}">{{ __('Dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('New') }} {{__('of')}} {{ __('group') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-0">
                    ...
                    <div class="card-body">
                        <form class="form form-validation" method="POST"  action="{{ route(BASE_ADMIN_PATH.'.groups.store')}}" enctype="multipart/form-data"  >
                            @csrf
