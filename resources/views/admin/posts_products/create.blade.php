<x-app-layout>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('New') }} {{ __('post') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="{{ url(BASE_ADMIN_URL) }}">{{ __('Dashboard') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('New') }} {{ __('post') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card m-0">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('New') }} {{ __('post') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form form-validation" method="POST"
                            action="{{ route(BASE_ADMIN_PATH . '.posts-products.store') }}"
    ...
    @section('script')
        ...
        <script src="https://cdn.tiny.cloud/1/ygro0ptah3nrevlz7hhp3kwv19nhhxqzvoi772o0km2ee3ql/tinymce/5/tinymce.min.js"
