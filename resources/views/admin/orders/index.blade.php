    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Orders List') }}</h2>
                  ...
                  <div class="dt-action-buttons text-end float-end" >
                        @can('orders.create')
                            <a href="{{route(BASE_ADMIN_PATH.'.orders.create')}}" class="dt-button create-new btn btn-primary "><span><i data-feather='plus'></i></span></a>
                        @endcan
                    </div>
                </div>
