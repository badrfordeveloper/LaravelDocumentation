<div class="card section-delivered-customer">
    <div class="card-header flex-column align-items-start">
        <h4 class="card-title">{{ __('Informations Address')}}</h4>
        @php
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="mb-1">
                    ...
                    <select class="select2 form-select" name="customer_id" data-action="{{ route(BASE_ADMIN_PATH.'.customers.index') }}">
            ...
            <div class="col-md-6 col-12">
                <div class="mb-1">
                    ...
                    <select class="select2 form-select" required name="city_id">
                        <option value="">{{ __('Select a item') }}</option>
            ...
            <div class="col-md-6 col-12">
                <div class="mb-1">
                    ...
                    <input value="{{ old('postcode', @$deliveredCustomer->postcode) }}" name="postcode" placeholder="{{ __('labels.postcode')}}"  type="text" class="form-control" />
