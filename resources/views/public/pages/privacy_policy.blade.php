<x-publics-layout>
                ...
                <div class="col">
                    <div class="breadcrumb-start">
                        <ul class="breadcrumb-url">
                            ...
                            <li class="breadcrumb-url-li">
                                <span>{{__('Politique de Confidentialité')}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="faq's-area section-tb-padding">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Collecte de l’information :</h4>
                        <div class="payment-content">
                            <p>
                                Nous recueillons des informations lorsque vous vous inscrivez sur notre site, lorsque vous vous connectez à votre compte, faites un achat, participez à un concours, et / ou lorsque vous vous déconnectez. Les informations recueillies incluent votre nom, votre adresse e-mail, numéro de téléphone, et carte de crédit.
                            </p>
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Utilisation des Informations :</h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Confidentialité du commerce en ligne : </h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Divulgation à des tiers : </h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Protection des Informations :</h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Est-ce que nous utilisons des cookies :</h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Se désabonner :</h4>
                        <div class="payment-content">
                            <p>
                    ...
                    <div class="payment">
                        <h4 class="payment-title">Consentement :</h4>
                        <div class="payment-content">
                            <p>
