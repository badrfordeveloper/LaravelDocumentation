                ...
                <div class="col">
                    <div class="style-2-full-blog-area">
                        <div class="single-image">
                            @php
                                $mainImage = $postsProduct->images()->where('type',TYPE_MAIN)->first();
                        ...
                        <div class="row">
                            <div class="col single-blog-content">
                                <div class="single-b-title">
                                    <h4>{{ $postsProduct->title }}</h4>
                                </div>
                                <div class="date-edit-comments">
                                    <div class="blog-info-wrap">
                                        <span class="blog-data date">
                                            <i class="icon-clock"></i>
                                            <span class="blog-d-n-c">{{ \Carbon\Carbon::parse($postsProduct->created_at)->format('j F Y') }}</span>
                                        </span>

                                    </div>
                                </div>
                                <div class="blog-description">
                                   {!! $postsProduct->description !!}
                                </div>

                                <div class="blog-social">
                                    @php
                                        $shareUrl = route('floursPosts.details',$postsProduct->slug);
                                    @endphp
                                     <!-- Facebook -->
